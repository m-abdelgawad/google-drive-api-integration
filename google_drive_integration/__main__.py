...
if __name__ == '__main__':
    ...
    key_file_path = 'data/input/google_drive_service_account_key.json'

    # Create a new object
    drive = GoogleDrive(key_file_location=key_file_path)

    # Get all files
    list_items = drive.get_list_items()
    drive.print_items(list_items)

    # # Get folder id
    # folder_id = drive.get_folder_id(folder_name='database')
    # print(folder_id)

    # # Get file id
    # file_id = drive.get_file_id(file_name='test1.txt')
    # print(file_id)

    # # Download the file
    # drive.download_file(file_name='remote_file.txt',
    ...
    #     remote_folder_name='database'
    # )

    # Delete a file
    # drive.delete_file(file_name='local_file.txt')
